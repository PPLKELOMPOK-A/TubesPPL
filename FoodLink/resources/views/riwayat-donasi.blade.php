...
<div class="page-wrapper">
    ...
    {{-- Notifikasi Session (Dari kode lama) --}}
    @if(session('success'))
    ...
    <div class="filter-tabs">
        ...
        <a href="{{ route('riwayat-donasi.index', ['status' => 'diretur', 'search' => request('search')]) }}" 
             class="tab-btn tab-diretur {{ request('status') == 'diretur' ? 'active' : '' }}">
    ...
    <div x-data="{ 
        ...
        <div class="donation-card" id="card-{{ $item->id }}">
            ...
            <div class="info-section">
                ...
                {{-- Badge Status Dinamis (Sesuai Alur: Pending -> Disetujui/Ditolak -> Diproses -> Selesai) --}}
                @if($status == 'selesai')
            ...
            {{-- Action Group (Sebelah Kanan) --}}
            <div class="action-group">
                {{-- Edit & Batal HANYA MUNCUL saat Pending --}}
                @if($isPending)
