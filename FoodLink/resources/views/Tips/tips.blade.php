...
<style>
    ...
    .illustration-container { display: flex; justify-content: center; width: 100%; margin-bottom: 30px; }
    .illustration-img { width: 480px; max-width: 100%; border-radius: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
    .feature-heading { font-size: 26px; font-weight: 700; color: #1e4620; margin: 15px 0 10px 0; }
    .feature-desc { color: #555; font-size: 15px; line-height: 1.6; margin: 0 auto 35px auto; }
    .nominal-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; margin-bottom: 20px; }
    .btn-nominal { background: #f8f9fa; border: 1px solid #e2e8f0; color: #333; padding: 14px; border-radius: 10px; font-size: 14px; font-weight: 700; cursor: pointer; transition: 0.2s; }
    .btn-nominal.selected { background: #46854d; color: white; border-color: #46854d; }
    .input-custom, .input-message { width: 100%; background: #f8f9fa; border: 1px solid #e2e8f0; padding: 14px 20px; border-radius: 10px; font-size: 14px; font-weight: 600; color: #333; box-sizing: border-box; margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }
    .input-custom input, .input-message input { border: none; background: transparent; width: 100%; outline: none; font-family: 'Poppins', sans-serif; font-weight: 600; color: #333; }
    .btn-submit { width: 100%; background: #46854d; color: white; border: none; padding: 16px; border-radius: 10px; font-size: 16px; font-weight: 700; cursor: pointer; margin-top: 10px; box-shadow: 0 4px 6px rgba(70, 133, 77, 0.2); transition: 0.3s; }
...
@section('content')
<div x-data="{ nominalSelected: 25000, customNominal: '', pesan: '' }">
