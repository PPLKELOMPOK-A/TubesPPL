...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex space-x-2 mb-6">
        ...
        <a href="{{ route('validasi.ditolak') }}" class="bg-[#E5E7EB] text-gray-700 px-6 py-2 rounded-lg text-xs font-bold shadow-sm">Ditolak</a>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white border border-gray-100 p-5 rounded-2xl flex flex-col md:flex-row gap-6 relative shadow-sm">
            ...
            <div class="flex-1 pt-1">
                ...
                <!-- BARIS BADGES: Menambahkan Layak Konsumsi & Expired -->
