    ...
    <style>
        * {
        ...
        .nav-item:hover:not(.active) {
            background-color: rgba(107, 79, 42, 0.1);
        }
    ...
    <div class="nav-group">
        ...
        @if(Auth::check() && Auth::user()->role == 'admin')
            ...
            <a href="{{ route('admin.validasi.index') }}"
               class="nav-item {{ Request::is('admin/validasi-proses-donasi*') ? 'active' : '' }}">
            ...
            @if(Route::has('mitra.index'))
                <a href="{{ route('mitra.index') }}"
                   class="nav-item {{ Request::is('admin/kerjasama-mitra*') ? 'active' : '' }}">
        ...
        @else
            ...
            @if(Route::has('riwayat_donasi.index'))
                <a href="{{ route('riwayat_donasi.index') }}"
                   class="nav-item {{ Request::is('riwayat-donasi*') ? 'active' : '' }}">
...
<div class="main-panel">
    ...
    <div class="top-bar">
        ...
        <div class="profile-section">
            ...
            <img
                src="https://ui-avatars.com/api/?name={{ Auth::user() ? Auth::user()->name : 'User' }}&background=6B4F2A&color=fff"
                class="user-avatar"
                alt="User Avatar">
        </div>
