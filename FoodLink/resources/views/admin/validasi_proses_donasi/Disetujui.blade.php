...
@section('title', 'Disetujui - Foodlink')
...
<style>
    ...
    /* Progress Timeline Khusus Disetujui */
...
<div class="validasi-canvas">
    ...
    <div class="tabs-container">
        ...
        <a href="{{ route('admin.validasi.disetujui') }}" class="tab-btn active">Disetujui</a>
    ...
    <div class="donasi-list-container">
        ...
        @empty
            <div style="text-align: center; padding: 40px; color: #888; background: #fff; border-radius: 12px;">Belum ada donasi yang disetujui.</div>
        @endforelse
    </div>
</div>
@endsection