...
<head>
    ...
    <title>Foodlink Admin - Buat Postingan Donasi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .nav-item { 
            display: flex; align-items: center; padding: 12px 20px; text-decoration: none; color: #4A4A4A; font-size: 14px; font-weight: 500; gap: 15px; margin-bottom: 6px; border-radius: 10px; transition: 0.2s;
        }
        ...
        .header-title { font-size: 24px; font-weight: 700; color: #111; margin-bottom: 30px; }
...
<div class="sidebar">
    ...
    <div class="main-panel">
        <div class="top-bar">
            ...
            <span style="font-size: 13px; font-weight: 600; color: #444; margin-right: 10px;">Admin</span>
            <img src="https://ui-avatars.com/api/?name=Admin&background=6B4F2A&color=fff" class="user-avatar" alt="Admin">
        </div>

        <div class="container">
            <h1 class="header-title">Buat Postingan Donasi</h1>

            <form action="{{ route('admin.donasi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label>Judul</label>
                    <input type="text" name="judul" value="" placeholder="Masukkan judul donasi" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="image-container">
                        <div class="preview-box">
                            <img id="img-preview" src="https://via.placeholder.com/400x250/f5f5f5/cccccc?text=Upload+Foto" alt="Preview">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" rows="4" placeholder="Jelaskan detail kegiatan..." required></textarea>
                </div>

                <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" name="alamat" value="" placeholder="Masukkan alamat penyaluran" required>
                </div>
